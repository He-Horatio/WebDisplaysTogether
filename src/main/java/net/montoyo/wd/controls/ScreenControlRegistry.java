...
public class ScreenControlRegistry {
	...
	// https://github.com/Mysticpasta1/webdisplaystogether/blob/ff55cbf1b27773c15f44f17ad3364da3a16b6ed9/src/main/java/net/montoyo/wd/net/server/SMessageScreenCtrl.java#L281-L364
	// https://github.com/Mysticpasta1/webdisplaystogether/blob/5ce9e4574df356910645b0382628f74d1401e26d/src/main/java/net/montoyo/wd/net/client_bound/S2CMessageScreenUpdate.java#L261-L284
	static {
		...
		register(ScreenSettingsControl.id, new ScreenControlType<>(ScreenSettingsControl.class, ScreenSettingsControl::new));
	}
