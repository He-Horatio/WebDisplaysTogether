...
public abstract class ScreenRights {
    ...
    public static final int BIND_DEVICES = 16; //Link peripherals (keyboards, speakers...) AND change screen settings
    @Deprecated(forRemoval = true)
    ...
    public static final int DEFAULTS = CHANGE_URL | INTERACT | BIND_DEVICES | MODIFY_SCREEN;
}
