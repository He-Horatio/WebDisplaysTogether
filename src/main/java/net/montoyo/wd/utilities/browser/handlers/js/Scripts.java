...
public class Scripts {
    ...
    @FileName("assets/webdisplaystogether/js/pointer_lock.js")
    public static final String POINTER_LOCK = get();
    @FileName("assets/webdisplaystogether/js/mouse_event.js")
    public static final String MOUSE_EVENT = get();
    @FileName("assets/webdisplaystogether/js/query_element.js")
