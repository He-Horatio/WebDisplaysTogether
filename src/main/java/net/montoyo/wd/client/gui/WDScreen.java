...
public abstract class WDScreen extends Screen {
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        //No short-circuit: every control must see the release to clear its dragging state
        boolean mouseReleased = false;

        for(Control ctrl: controls)
            mouseReleased |= ctrl.mouseReleased(mouseX, mouseY, button);
    ...
    public boolean mouseDragged(double mouseX, double mouseY, int button, double dragX, double dragY) {
        //No short-circuit: only controls that started a drag will react
        boolean dragged = false;

        for(Control ctrl: controls)
            dragged |= ctrl.mouseClickMove(mouseX, mouseY, button, dragX, dragY);
