...
public class CheckBox extends BasicControl {
    ...
    private static final ResourceLocation texUnchecked = new ResourceLocation("webdisplaystogether", "textures/gui/checkbox.png");
    private static final ResourceLocation texChecked = new ResourceLocation("webdisplaystogether", "textures/gui/checkbox_checked.png");
