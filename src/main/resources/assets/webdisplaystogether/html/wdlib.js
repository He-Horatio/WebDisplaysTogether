...
function wdExecRequest(name, func) {
	window.cefQuery({	request: "WDT_" + name,
						persistent: true,
...
//Requires upgrade: webdisplaystogether:redinput
...
//Requires upgrade: webdisplaystogether:redoutput
...
//Requires upgrade: webdisplaystogether:gps
